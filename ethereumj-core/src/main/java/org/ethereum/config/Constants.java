...
public class Constants {
    ...
    public static BigInteger MINIMUM_DIFFICULTY = BigInteger.valueOf(1);
    ...
    public static final long HOMESTEAD_FORK_BLKNUM = 10_000_000; // TODO change block when finalized
